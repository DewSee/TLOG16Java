...
public class Util {
	...
	/**
	 * If a task !isMultipleQuarterHour, changes the endTime,
	 * so the getMinPerTask will be a multiple of 15.
	 *
	 * @param task
	 */
	...
	/**
	 * Checks whether 2 tasks' times are overlapping or not.
	 * 3 cases give false (overlapping) result:
	 * The task's startTime is between the existingTask's startTime and endTime
	 * The task's endTime is between the existingTask's startTime and endTime
	 * The task's startTime AND endTime are both between the existingTask's startTime and endTime
	 *
